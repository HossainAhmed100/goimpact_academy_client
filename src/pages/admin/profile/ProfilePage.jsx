          ...
          <div className="mt-4 flex flex-col items-start gap-4">
            <div className="grid lg:grid-cols-2 gap-4 grid-cols-1">
              <div className="bg-gray-100 flex items-center gap-2 p-4 rounded-lg">
                <div className="rounded-full shadow-md p-4 items-center justify-center flex">
                  <FaLocationDot color="#DB4444" size={20}/>
                </div>
            ...
            <Button 
              ...
              radius="sm" 
              className="text-blue-400 border font-semibold border-default-300 shadow bg-transparent">
              Add new address
            </Button>
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-4 flex flex-col gap-4">
            ...
            <Button 
              startContent={<HiPlus className="font-medium"/>} 
              radius="sm" 
              className="text-blue-400 w-44 border font-semibold border-default-300 shadow bg-transparent">
              Add new address
            </Button>
          </div>
        </div>
